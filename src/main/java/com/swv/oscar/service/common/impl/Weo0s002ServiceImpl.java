...
public class Weo0s002ServiceImpl implements  IWeo0s002Service {
    ...
    public Weo0s002BO execute(Weo0s002BO weo0s002BOReq) throws OscarBusinessException {
        LOGGER.debug("Request: "+weo0s002BOReq);
        Weo0s002BO weo0s002BOResp = null;
        try {
            weo0s002BOResp =  new Weo0s002BO();
            Weo0s002 weo0s002 = (Weo0s002) weo0s002BOReq.getFirst(weo0s002BOReq.getWeo0s002());
            //
            // SIGNED OUT BY:
            //
            //
