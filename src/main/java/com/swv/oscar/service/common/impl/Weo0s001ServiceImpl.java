...
public class Weo0s001ServiceImpl implements  IWeo0s001Service {
    ...
    public Weo0s001BO execute(Weo0s001BO weo0s001BOReq) throws OscarBusinessException {
        LOGGER.debug("Request: "+weo0s001BOReq);
        Weo0s001BO weo0s001BOResp = null;
        try {
            weo0s001BOResp =  new Weo0s001BO();
            Weo0s001 weo0s001 = (Weo0s001) weo0s001BOReq.getFirst(weo0s001BOReq.getWeo0s001());
            //
            // SIGNED OUT:                                 DATE:
            //
    ...
    public Weo0s001BO navigateOut(Weo0s001BO weo0s001BOReq) throws OscarBusinessException {
        ...
        try {
            ...
            if(weo0s001.getgStackedPanel().equalsIgnoreCase(" ")) {
                ...
                //TODO
                /*validateCommand(weo0s001BOResp);*/
            } else {
                ...
                if(weo0s001.getgPanel().equalsIgnoreCase("DJSR")) {
                    ...
                    if(weo0s001BOResp.getWeo0s001().size() == 0) {
                    }
                ...
                // MLM -END- 06-23-10
                //TODO
//                weo0s001.setgStackedPanel125(weo0s001.setgStackedPanel(226));
