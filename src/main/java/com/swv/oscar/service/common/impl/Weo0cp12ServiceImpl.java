...
import com.swv.oscar.dataobject.common.Weo0cp12;
...
public class Weo0cp12ServiceImpl implements IWeo0cp12Service {
	...
	public Weo0cp12BO execute(BaseBO weo0cp12BOReq) throws OscarBusinessException {
		LOGGER.debug("Request: " + weo0cp12BOReq);
		Weo0cp12BO weo0cp12BOResp = null;
		try {
			weo0cp12BOResp = new Weo0cp12BO();
	...
	public Weo0cp12BO executeENTR(Weo0cp12BO weo0cp12BOReq) throws OscarBusinessException {
		...
		try {
			weo0cp12BOResp = new Weo0cp12BO();
			Weo0cp12 weo0cp12 = (Weo0cp12) weo0cp12BOReq.getFirst(weo0cp12BOReq.getWeo0cp12());
