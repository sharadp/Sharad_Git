...
// Revision History :
public class Weo0chkpBO extends BaseBO implements Serializable {

    private List<Weo0chkp> weo0chkp;
    private List<Weo0nenv> weo0nenv;
    
    public List<Weo0chkp> getWeo0chkp() {
        return weo0chkp;
    }

    public void setWeo0chkp(List<Weo0chkp> weo0chkp ) {
        this.weo0chkp = weo0chkp;
    }
	...
	public String toString() {
		return "Weo0chkpBO [weo0chkp=" + weo0chkp + ", weo0nenv=" + weo0nenv + "]";
	}
}